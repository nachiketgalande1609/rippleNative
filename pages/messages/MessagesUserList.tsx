                ...
                {Array(7)
                    ...
                    .map((_, i) => (
                        <View key={i} style={[styles.userRow, { borderBottomColor: colors.border }]}>
                            {/* Avatar */}
                            <View style={[styles.avatar, { backgroundColor: colors.hover, borderRadius: 21 }]} />
                            {/* Content */}
        ...
        <View style={[styles.root, { backgroundColor: colors.bg, marginTop: -insets.top }]}>
            ...
            {loading ? (
                ...
                <View style={styles.emptyState}>
                    ...
                    <Text style={[styles.emptyText, { color: colors.textDisabled }]}>{search ? "No results found" : "No conversations yet."}</Text>
                </View>
            ) : (
                <>
                        ...
                        renderItem={({ item: user }) => {
                            ...
                            return (
                                <TouchableOpacity
                                    ...
                                    activeOpacity={0.7}
                                    style={[styles.userRow, { borderBottomColor: colors.border }, isActive && { backgroundColor: colors.selected }]}
                                >
                                    {/* Avatar */}
                                    <View style={styles.avatarWrap}>
                                        {user.profile_picture ? (
                                            ...
                                            <View style={[styles.avatar, styles.avatarInitials, { backgroundColor: avatarColor.bg }]}>
                                                <Text style={[styles.initialsText, { color: avatarColor.color }]}>{getInitials(user.username)}</Text>
                                            </View>
                                        )}
                                    ...
                                    <View style={styles.userContent}>
                                        ...
                                        <Text
                                            style={[
                                                styles.userPreview,
                                                {
                                                    color: hasUnread ? colors.textSecondary : colors.textDisabled,
