...
const PostDetailPage = () => {
    ...
    return (
        <SafeAreaView style={[styles.root, { backgroundColor: colors.bg, marginBottom: 62, marginTop: -insets.top }]} edges={["top"]}>
            {/* ── Top nav ── */}
            <View style={[styles.topNav, { backgroundColor: colors.surface, borderBottomColor: colors.border }]}>
            ...
            <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === "ios" ? "padding" : "height"}>
                ...
                <View style={[styles.inputBar, { backgroundColor: colors.surface, borderTopColor: colors.border }]}>
                    ...
                    <TextInput
                        ...
                        multiline={false}
                    />
                    <TouchableOpacity onPress={handleComment} disabled={!canSend || submitting} activeOpacity={0.8}>
                        {submitting ? (
                            <ActivityIndicator size={14} color={ACCENT} />
                        ) : (
                            <Text style={[styles.sendText, { color: canSend ? ACCENT : colors.textDisabled, fontWeight: canSend ? "600" : "400" }]}>
                                Post
                            </Text>
                        )}
                    </TouchableOpacity>
