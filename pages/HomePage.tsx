    ...
    >
      ...
      {username && (
        <Text
          style={[
            styles.storyLabel,
            { color: colors.textSecondary, maxWidth: size + 10 },
          ]}
          numberOfLines={1}
        >
          {username}
      ...
      >
        ...
        <View style={styles.skeletonHeader}>
          ...
          <View style={{ flex: 1, gap: 7 }}>
            <View
              style={[
                styles.skeletonLine,
                { width: "45%", backgroundColor: colors.hover },
              ]}
            />
            <View
              style={[
                styles.skeletonLine,
                { width: "25%", height: 9, backgroundColor: colors.hover },
              ]}
            />
          </View>
          <View
        ...
        <View style={styles.skeletonActions}>
          {[56, 40, 32].map((w, i) => (
            <View
              ...
              style={[
                styles.skeletonLine,
                { width: w, height: 13, backgroundColor: colors.hover },
              ]}
            />
          ))}
        </View>
        ...
        <View style={[styles.skeletonCaption, { gap: 6 }]}>
          <View
            style={[
              styles.skeletonLine,
              { width: "80%", backgroundColor: colors.hover },
            ]}
          />
          <View
            style={[
              styles.skeletonLine,
              { width: "55%", height: 10, backgroundColor: colors.hover },
            ]}
          />
        </View>
      </View>
...
export default function HomePage() {
  ...
  const StoriesHeader = () => (
    <>
      ...
      {!loadingPosts && posts.length > 0 && (
        <View style={[styles.feedLabel, { borderBottomColor: colors.border }]}>
          <Text style={[styles.feedLabelText, { color: colors.textDisabled }]}>
            For you
          </Text>
        </View>
      )}
  ...
  return (
    <SafeAreaView
      style={[
        styles.root,
        { backgroundColor: colors.bg, marginTop: -insets.top },
      ]}
      edges={["top"]}
    >
      <FlatList
