  ...
  return (
    <Animated.View style={{ opacity: pulse }}>
      ...
      <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
        ...
        {/* Header row: avatar left, name/bio right */}
        <View style={{ flexDirection: "row", alignItems: "flex-start", gap: 14, marginBottom: 14 }}>
          {/* Avatar circle */}
          <View style={{ width: 80, height: 80, borderRadius: 40, backgroundColor: colors.hover, flexShrink: 0 }} />

          {/* Name + bio + meta chips */}
          <View style={{ flex: 1, paddingTop: 4, gap: 4 }}>
            <View style={{ width: "55%", height: 15, borderRadius: 6, backgroundColor: colors.hover }} />
            <View style={{ width: "90%", height: 11, borderRadius: 5, backgroundColor: colors.hover, marginTop: 4 }} />
            <View style={{ width: "70%", height: 11, borderRadius: 5, backgroundColor: colors.hover }} />
            <View style={{ flexDirection: "row", gap: 5, marginTop: 4 }}>
              <View style={{ width: 70, height: 22, borderRadius: 20, backgroundColor: colors.hover }} />
              <View style={{ width: 90, height: 22, borderRadius: 20, backgroundColor: colors.hover }} />
            </View>
          </View>
        </View>
        ...
        <View style={{
          ...
          {[0, 1, 2].map((i) => (
            <React.Fragment key={i}>
              <View style={{ flex: 1, alignItems: "center", paddingVertical: 12, gap: 6 }}>
                <View style={{ width: 36, height: 18, borderRadius: 6, backgroundColor: colors.hover }} />
                <View style={{ width: 52, height: 10, borderRadius: 5, backgroundColor: colors.hover }} />
              </View>
              {i < 2 && (
                <View style={{ width: 0.5, height: 22, backgroundColor: colors.border, opacity: 0.4 }} />
              )}
            </React.Fragment>
          ))}
        </View>
      ...
      <View style={{
        ...
        {[0, 1].map((i) => (
          <View key={i} style={{ flex: 1, height: 46, alignItems: "center", justifyContent: "center" }}>
            <View style={{ width: 22, height: 22, borderRadius: 4, backgroundColor: colors.hover }} />
          </View>
        ))}
      </View>
      ...
      <View style={{ flexDirection: "row", flexWrap: "wrap" }}>
        {Array(9).fill(0).map((_, i) => (
          <View
            key={i}
            style={{ width: "33.333%", aspectRatio: 1, padding: 0.5, backgroundColor: colors.hover }}
          />
        ))}
      </View>
    </Animated.View>
...
function Stat({
  ...
  return (
    ...
    >
      ...
      <Text style={[styles.statLabel, { color: colors.textDisabled }]}>
        {label}
      </Text>
    </TouchableOpacity>
  );
  ...
  const handleFollow = async () => {
    ...
    try {
      ...
      if (res?.success) {
        ...
        setProfileData((p) =>
          p
            ? { ...p, is_following: true, is_request_active: true, followers_count: p.followers_count + 1 }
            : p,
        );
      }
    } catch (e) {
  ...
  const handleCancelRequest = async () => {
    ...
    try {
      ...
      if (res?.success) {
        ...
        setProfileData((p) =>
          p
            ? { ...p, is_following: false, is_request_active: false, followers_count: p.followers_count - 1 }
            : p,
        );
      }
    } catch (e) {
              ...
              {isOwnProfile ? (
                ...
                <>
                  ...
                  <TouchableOpacity
                    ...
                    style={[
                      styles.actionBtn,
                      { flex: 1, backgroundColor: colors.hover, borderColor: colors.border },
                    ]}
                  >
          ...
          >
            {[
              ...
              <TouchableOpacity
                ...
                style={[
                  styles.tab,
                  tab === t.idx && { borderBottomWidth: 2, borderBottomColor: ACCENT },
                ]}
              >
                <Ionicons
