...
function ProfileSkeleton({ colors }: { colors: any }) {
  ...
  return (
    <Animated.View
      style={{ opacity: pulse, paddingHorizontal: 16, paddingTop: 20, gap: 16 }}
    >
      {/* Avatar */}
      <View
        style={{
  ...
  return (
    ...
    >
      ...
      {fetchingProfile ? (
        ...
        >
          <View
            style={[styles.avatarArea, { backgroundColor: colors.surface }]}
          >
            <View
              style={[
          ...
          >
            ...
            <View style={styles.metaRow}>
              {profileData?.location && (
                <View
                  style={[styles.metaChip, { backgroundColor: colors.hover }]}
                >
                  <Ionicons
