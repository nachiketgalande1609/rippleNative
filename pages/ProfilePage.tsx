...
const CELL = Math.floor((SW - 3) / 3); // floor to avoid sub-pixel gaps
    ...
    >
      ...
      >
        ...
        <View style={styles.topBarCenter}>
          ...
          <Text
            style={[styles.topBarUsername, { color: colors.textPrimary }]}
            numberOfLines={1}
          >
          ...
          <View style={styles.avatarRow}>
            ...
            <View style={styles.actionRow}>
              ...
              {isOwnProfile && (
                ...
                >
                  <Text
                    style={[styles.editBtnText, { color: colors.textPrimary }]}
                  >
                    Edit profile
                  </Text>
                </TouchableOpacity>
        ...
        >
          ...
          >
            <Ionicons
              name="grid-outline"
              size={14}
              color={tab === 0 ? colors.textPrimary : colors.textDisabled}
            />
            <Text
              style={[
                styles.tabLabel,
          ...
          {isOwnProfile && (
            ...
            >
              <Ionicons
                ...
                size={14}
                color={tab === 1 ? colors.textPrimary : colors.textDisabled}
              />
              <Text
                style={[
                  styles.tabLabel,
            ...
            <EmptyState
              ...
              action={
                isOwnProfile && tab === 0 ? (
                  ...
                  >
                    <Text style={[styles.createBtnText, { color: colors.bg }]}>
