    ...
    >
      ...
      <View style={{ flex: 1, gap: 8 }}>
        <View
          style={[
            styles.skeletonLine,
            { width: "65%", backgroundColor: colors.hover },
          ]}
        />
        <View
          style={[
            styles.skeletonLine,
            { width: "40%", height: 10, backgroundColor: colors.hover },
          ]}
        />
      </View>
      {/* Thumb placeholder */}
      ...
      <View style={styles.inner}>
        ...
        <View style={[styles.header, { borderBottomColor: colors.border }]}>
          ...
          {!loading && notifications.length > 0 && (
            ...
            >
              <Text
                style={[styles.totalBadgeText, { color: colors.textDisabled }]}
              >
          ...
          {loading ? (
            ...
            <View style={styles.emptyState}>
              ...
              >
                <Ionicons
                  name={
                    activeTab === 1 ? "people-outline" : "notifications-outline"
                  }
                  size={28}
