      ...
      <View style={styles.userRow}>
        ...
        <View style={{ flex: 1, gap: 7 }}>
          <View
            style={[
              styles.skeletonLine,
              { width: "40%", backgroundColor: colors.hover },
            ]}
          />
          <View
            style={[
              styles.skeletonLine,
              { width: "60%", height: 10, backgroundColor: colors.hover },
            ]}
          />
        </View>
      </View>
      ...
      <View style={styles.grid}>
        {Array(9)
          ...
          .map((_, i) => (
            <View
              key={i}
              style={[styles.gridCell, { backgroundColor: colors.hover }]}
            />
          ))}
      </View>
    </SkeletonPulse>
...
function EmptyState({
  ...
  return (
    <View style={styles.emptyState}>
      {icon}
      <Text style={[styles.emptyPrimary, { color: colors.textSecondary }]}>
        {primary}
      </Text>
      <Text style={[styles.emptySecondary, { color: colors.textDisabled }]}>
        {secondary}
      </Text>
    </View>
  );
...
export default function SearchPage() {
  ...
  const isTagSearching =
    !!debouncedTagQuery &&
    !!(tagQuery.startsWith("#") ? tagQuery.slice(1) : tagQuery).trim();
        ...
        <View style={styles.inputWrapper}>
          ...
          >
            ...
            <TextInput
              ...
              placeholder={
                activeTab === 0 ? "Search people…" : "Search #hashtags…"
              }
            ...
            {(activeTab === 0 ? userQuery : tagQuery) ? (
              <TouchableOpacity
                onPress={() =>
                  activeTab === 0 ? setUserQuery("") : setTagQuery("")
                }
                hitSlop={{ top: 8, bottom: 8, left: 8, right: 8 }}
              >
                <Ionicons
          ...
          {isLoading && (
            <View style={styles.loadingBar}>
              <View
                style={[styles.loadingBarFill, { backgroundColor: ACCENT }]}
              />
            </View>
          )}
        </View>
          ...
          {[
            ...
            >
              <Ionicons
                ...
                size={14}
                color={
                  activeTab === i ? colors.textPrimary : colors.textDisabled
                }
              />
              <Text
                style={[
