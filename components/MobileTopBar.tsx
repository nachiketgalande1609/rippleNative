...
export default function MobileTopBar({ unreadNotificationsCount }: MobileTopBarProps) {
    ...
    return (
        <SafeAreaView style={[styles.safeArea, { backgroundColor: colors.surface, borderBottomColor: colors.border }]}>
